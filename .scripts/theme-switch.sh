...
then
	...
	sed -i -e 's/Default Light+/Materia Contrast/' ~/.config/Code\ -\ OSS/User/settings.json
	...
	sed -i -e 's/Materia Contrast/Default Light+/' ~/.config/Code\ -\ OSS/User/settings.json
